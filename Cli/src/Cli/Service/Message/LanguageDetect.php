...
use Cli\Service\Message\LanguageDetect\Exception;
use Cli\Service\Message\LanguageDetect\Parser;
use Cli\Service\Message\LanguageDetect\ISO639;
...
class LanguageDetect
{
    ...
    {
        return __DIR__ . DIRECTORY_SEPARATOR . 'LanguageDetect' . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . $fname;
    }
        ...
        if (!is_array($trigram)) {
            if (ini_get('magic_quotes_runtime')) {
                throw new Exception(
                    ...
                    Exception::MAGIC_QUOTES
                );
            }
            throw new Exception(
                'Language database is not an array.',
                Exception::DB_NOT_ARRAY
            );
